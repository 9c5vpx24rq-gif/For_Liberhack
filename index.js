    ...
    if (votes === EMAIL_THRESHOLD) {
      ...
      try {
        await transporter.sendMail({
          ...
          subject: `GLASS Сигнал: ${cityName} — ${votes} граждани сигнализират за проблем`,
          text: `
До Община Бургас,

Платформата GLASS регистрира граждански сигнал, достигнал критичен брой гласове.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
НАСЕЛЕНО МЯСТО: ${cityName}
КАТЕГОРИЯ: ${modeText.toUpperCase()}
БРОЙ ГЛАСОВЕ: ${votes}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

${problemText}

${votes} граждани са потвърдили лично този проблем чрез платформата GLASS. Това е автоматично генерирано писмо при достигане на прага от ${EMAIL_THRESHOLD} гласа.

Молим за предприемане на конкретни действия и обратна връзка с гражданите.

С уважение,
Платформа GLASS
Граждански Локална Активност & Социална Сигнализация
glass.signals.bg@gmail.com
          `,
        });
